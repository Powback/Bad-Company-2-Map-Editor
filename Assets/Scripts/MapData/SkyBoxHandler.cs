...
public class SkyBoxHandler : MonoBehaviour {
	...
	void Start () {
		...
		Texture skyBoxTexture = (Texture) Resources.Load ("Terrains/" + mapName + "/Textures/" + mapName + "_Sky.itexture");
		if (skyBoxTexture == null) {
			...
			Texture skyBoxTextureR = (Texture) Resources.Load ("Terrains/" + mapName + "R/Textures/" + mapName + "_Sky.itexture");
			Texture skyBoxTexture_01 = (Texture) Resources.Load ("Terrains/" + mapName + "/Textures/" + mapCompact + "_Sky_01.itexture");
			Texture skyBoxTexture1 = (Texture) Resources.Load ("Terrains/" + mapName + "/Textures/" + mapCompact2 + "_Sky_01.itexture");
			Texture skyBoxTexture01 = (Texture) Resources.Load ("Terrains/" + mapName + "/Textures/" + mapCompact3 + "_Sky_01.itexture");
			Texture skyBoxTexture01c = (Texture) Resources.Load ("Terrains/" + mapName + "/Textures/" + mapCompact3 + "_Sky_01_c.itexture");
